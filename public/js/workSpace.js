...
$(document).ready(function () {
  ...
  function addResource() {
    ...
    $.post("/api/resource-new/" + userId + "/" + projectId + "/" + thisTopic + "/" + resourceName, function (newTopic) {
  ...
  function getTopicsAndResources(uID, pID) {
    ...
    $.get("/api/" + uID + "/" + pID + "/topics", function (topics) {
      ...
      for (let i = 0; i < topics.length; i++) {
        ...
        var topicHeadline = $("<div class='input-group mb-3'><div class='input-group-prepend'><button class='btn btn-outline-secondary' type='button' id='topic-delete-button-" + tID + "' data-topic='" + tID + "'> X </button></div><input id='add-topic-name-" + pID + "' type='text' class='form-control' placeholder='" + topicName + "'></div>");
        ...
        $(document).on("click", "#topic-delete-button-" + tID, deleteTopic);
        ...
        $.get("/api/" + uID + "/" + pID + "/" + tID + "/resources", function (resources) {
          ...
          for (let j = 0; j < resources.length; j++) {
            ...
            // event handler for the "Delete Resource" burn icon button
            $(document).on("click", "#delete-resource-button-" + resourceId, deleteResource);
